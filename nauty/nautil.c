...
void
writeperm(FILE *f, int *perm, boolean_nauty cartesian, int linelength, int n)
{
...
doref(graph *g, int *lab, int *ptn, int level, int *numcells,
     ...
     void (*invarproc)(graph*,int*,int*,int,int,int,int*,
                                                 int,boolean_nauty,int,int),
     int mininvarlev, int maxinvarlev, int invararg,
    boolean_nauty digraph, int m, int n)
{
    int pw;
...
maketargetcell(graph *g, int *lab, int *ptn, int level, set *tcell,
       int *tcellsize, int *cellpos, int tc_level, boolean_nauty digraph,
       int hint,
       int (*targetcell)(graph*,int*,int*,int,int, boolean_nauty,int,int,int),
       int m, int n)
{
    int i,j,k;
