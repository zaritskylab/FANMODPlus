...
void
readgraph(FILE *f, graph *g, boolean_nauty digraph, boolean_nauty prompt,
      boolean_nauty edit, int linelength, int m, int n)
{
    int v,c;
    int curlen,w;
    graph *gv;
...
void
readgraph_sg(FILE *f, sparsegraph *sg, boolean_nauty digraph, boolean_nauty prompt,
             int linelength, int n)
{
    int i,j,k,vv,ww,c;
    boolean_nauty neg,done;
    int *d,*e,*evi;
...
void
readgraph_swg(FILE *f, sparsegraph *sg, boolean_nauty digraph, boolean_nauty prompt,
             int linelength, int n)
{
    int i,j,k,vv,ww,c;
    boolean_nauty neg,done;
...
void
readptn(FILE *f, int *lab, int *ptn, int *numcells, boolean_nauty prompt, int n)
{
    int i,j;
    int c,v1,v2,m;
...
void
readperm(FILE *f, int *perm, boolean_nauty prompt, int n)
{
    int nv;
...
void
readvperm(FILE *f, int *perm, boolean_nauty prompt, int n, int *nv)
{
    int i;
    int m,c,v1,v2;
...
void
rangraph(graph *g, boolean_nauty digraph, int invprob, int m, int n)
{
    int i,j;
    long li;
    set *row,*col;
...
void
rangraph2(graph *g, boolean_nauty digraph, int p1, int p2, int m, int n)
{
    int i,j;
    long li;
    set *row,*col;
...
void
rangraph2_sg(sparsegraph *sg, boolean_nauty digraph, int p1, int p2, int n)
{
    int i,j,k;
    int *dd,*ee;
