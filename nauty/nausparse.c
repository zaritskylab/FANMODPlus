...
boolean_nauty
isautom_sg(graph *g, int *p, boolean_nauty digraph, int m, int n)
{
    int *d,*e;
    size_t *v;
    int i,pi,di;
...
boolean_nauty
cheapautom_sg(int *ptn, int level, boolean_nauty digraph, int n)
{
    int i,k,nnt;
...
targetcell_sg(graph *g, int *lab, int *ptn, int level, int tc_level,
       boolean_nauty digraph, int hint, int m, int n)
{
    int i;
...
void
put_sg(FILE *f, sparsegraph *sg, boolean_nauty digraph, int linelength)
{
    int *d,*e;
    int n,di;
    int i,curlen,slen;
...
distances_sg(graph *g, int *lab, int *ptn, int level, int numcells, int tvpos,
         int *invar, int invararg, boolean_nauty digraph, int m, int n)
{
    int *d,*e;
    int i,k,dlim,wt;
    int di;
...
adjacencies_sg(graph *g, int *lab, int *ptn, int level, int numcells,
               int tvpos, int *invar, int invararg, boolean_nauty digraph,
               int m, int n)
{
    int *d,*e;
    int vwt,wwt;
