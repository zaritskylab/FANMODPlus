...
static TLS_ATTR
   boolean_nauty getcanon,digraph,writeautoms,domarkers,cartesian,doschreier;
...
static TLS_ATTR void (*invarproc)
          (graph*,int*,int*,int,int,int,int*,int,boolean_nauty,int,int);
...
static TLS_ATTR boolean_nauty needshortprune;  /* used to flag calls to shortprune */
