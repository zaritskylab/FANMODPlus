...
extern void putset(FILE*,set*,int*,int,int,boolean_nauty);
extern void putset_firstbold(FILE*,set*,int*,int,int,boolean_nauty);
extern void rangraph(graph*,boolean_nauty,int,int,int);
extern void rangraph2(graph*,boolean_nauty,int,int,int,int);
extern void rangraph2_sg(sparsegraph*,boolean_nauty,int,int,int);
extern void ranreg_sg(sparsegraph *sg, int degree, int n);
extern void ranperm(int*,int);
extern void readgraph(FILE*,graph*,boolean_nauty,boolean_nauty,boolean_nauty,int,int,int);
extern void readgraph_sg(FILE*,sparsegraph*,boolean_nauty,boolean_nauty,int,int);
extern void readgraph_swg(FILE*,sparsegraph*,boolean_nauty,boolean_nauty,int,int);
extern boolean_nauty readinteger(FILE*,int*);
extern boolean_nauty readinteger_sl(FILE*,int*);
extern void readperm(FILE*,int*,boolean_nauty,int);
extern void readptn(FILE*,int*,int*,int*,boolean_nauty,int);
extern void readvperm(FILE*,int*,boolean_nauty,int,int*);
extern boolean_nauty readstring(FILE*,char*,int);
