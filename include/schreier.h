...
extern boolean_nauty addgenerator(schreier **gp, permnode **gens, int *p, int n);
extern boolean_nauty
	condaddgenerator(schreier **gp, permnode **gens, int *p, int n);
extern boolean_nauty expandschreier(schreier *gp, permnode **gens, int n);
