...
extern int targetcell_sg(graph*,int*,int*,int,int,boolean_nauty,int,int,int);
extern boolean_nauty cheapautom_sg(int*,int,boolean_nauty,int);
extern boolean_nauty isautom_sg(graph*,int*,boolean_nauty,int,int);
...
extern boolean_nauty aresame_sg(sparsegraph*,sparsegraph*);
extern void put_sg(FILE*,sparsegraph*,boolean_nauty,int);
...
extern void
   adjacencies_sg(graph*,int*,int*,int,int,int,int*,int,boolean_nauty,int,int);
extern void
   distances_sg(graph*,int*,int*,int,int,int,int*,int,boolean_nauty,int,int);
extern void
   distances_sg(graph*,int*,int*,int,int,int,int*,int,boolean_nauty,int,int);
